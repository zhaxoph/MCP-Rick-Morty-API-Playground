...
// Register API tools
server.tool("get-character", "Fetch a character by ID", {
...
server.tool("get-characters", "Fetch characters with pagination", {
    ...
    const formattedResponses = characters.map((character) => formatCharacterResponse({ properties: character }));
